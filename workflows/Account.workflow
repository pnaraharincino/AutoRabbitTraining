...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>Account_Set_Default_App</fullName>
        <field>LLC_BI__Default_App__c</field>
        <formula>&apos;relationship-training.relationship-loan-products&apos;</formula>
        <name>Account: Set Default App</name>
    ...
    <rules>
        ...
        <actions>
            <name>Account_Set_Default_App</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
