...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <description>Set the Record Type field to Group when the collateral mgmt record’s collateral type equals a group.</description>
        <field>RecordTypeId</field>
        <lookupValue>LLC_BI__Group</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
    ...
    <rules>
        ...
        <active>true</active>
        <description>This workflow rule sets the Record Type field to Group when the collateral mgmt record’s collateral type equals a group (Group Type field populated).</description>
