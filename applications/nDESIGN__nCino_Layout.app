...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <label>nCino Layout</label>
    <logo>Salesforce_Branding_Resources/Uni_Logo_20KB.png</logo>
    <tabs>nDESIGN__Screen_Section__c</tabs>
    <tabs>nDESIGN__View__c</tabs>
    <tabs>nDESIGN__Screen__c</tabs>
    <tabs>DM_Admin</tabs>
    ...
    <tabs>LLC_BI__Ownership_Structure_Type__c</tabs>
